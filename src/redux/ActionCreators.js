...
export const postComment = (dishId, rating, comment) => (dispatch) => {
    ...
    return fetch(baseUrl + 'api/comments', { // we are now communicating with the Loopback server instead of the REST API server that we had earlier. So fetch will now be accessing the Loopback server at the api/comments endpoint, the api/dishes endpoint and so on -  So all these fetch requests are updated to access our Loopback server instead
        method: 'POST',
